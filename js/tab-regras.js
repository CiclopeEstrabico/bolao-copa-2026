...
window.renderRegras = function() {
  ...
  const faqs = [
    ...
    ["Como funciona a diferença de gols?",
     "Se você acertou quem ganhou E a diferença de gols (ex: apostou 2×1, saiu 3×2 — ambos por 1 gol), ganha "+base+"+"+bDiff+" = <strong>"+(base+bDiff)+" pts</strong>. Se além disso acertou os gols de um dos times, significa que acertou o placar exato!"],
    ["O que acontece em jogos de pênaltis?",
     "O placar considerado é o do tempo regulamentar + prorrogação. Se o jogo foi para pênaltis, o placar 'empatado' já basta para você acertar o resultado. Não há placar exato em jogo de pênaltis."],
    ["Posso alterar meu palpite?",
     "Sim, até o prazo limite de cada fase. Após o início do primeiro jogo, os palpites daquela fase ficam bloqueados."],
    ["Como são os melhores terceiros?",
     "Na Copa 2026 com 12 grupos, os 8 melhores 3ºs colocados avançam. O critério segue: pontos → saldo de gols → gols marcados → confronto direto."],
