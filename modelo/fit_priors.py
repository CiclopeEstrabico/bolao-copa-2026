...
K_FACTORS = {
    ...
    'Superclásico de las Américas':                     40,
    'AFC Challenge Cup':                                40,
    'AFC Challenge Cup qualification':                  40,
    'AFC Solidarity Cup':                               40,
    'NAFC Championship':                                40,
    'NAFU Championship':                                40,
    'Melanesia Cup':                                    40,
    'Pacific Games':                                    40,
    ...
    'Palestine Cup':                                    30,
    'Palestine International Championship':             30,
    'Kuneitra Cup':                                     30,
    'Navruz Cup':                                       30,
    ...
    'Mapinduzi Cup':                                    30,
    'Simba Tournament':                                 30,
    'All-African Games':                                30,
    'Afro-Asian Games':                                 30,
    'African Friendship Games':                         30,
    'Central American and Caribbean Games':             30,
    'Bolivarian Games':                                 30,
    'South Asian Games':                                30,
    'South Asian Super Cup':                            30,
    'Southeast Asian Games':                            30,
    ...
    'CONIFA World Cup qualification':                   30,
    ...
    'ELF Cup':                                          30,
    'Muratti Vase':                                     30,
    'Inter-Allied Games':                               30,
    'Inter Games':                                      30,
    'Far Eastern Championship Games':                   30,
    'Hungary Heritage Cup':                             30,
    'Benedikt Fontana Cup':                             30,
    'Évence Coppée Trophy':                             30,
    'Matthews Cup':                                     30,
    'Marlboro Cup':                                     30,
    'Millennium Cup':                                   30,
    'Merlion Cup':                                      30,
    ...
    'Mukuru 4 Nations':                                 30,
    'Niamh Challenge Cup':                              30,
    'Nations Cup':                                      30,
    'OSN Cup':                                          30,
    'Open International Championship':                  30,
    'Outrigger Challenge Cup':                          30,
    'Real Madrid 75th Anniversary Cup':                 30,
    'Scania 100 Tournament':                            30,
    'Joe Robbie Cup':                                   30,
    ...
    'World Unity Cup':                                  30,
    'Zambian Independence Tournament':                  30,
    'Mahinda Rajapaksa Cup':                            30,
    'Philippine Peace Cup':                             30,
    ...
    'International Tournament of Peoples':              30,
...
K_DEFAULT = 30   # torneios não mapeados tratados como "outros torneios" (K=30)
