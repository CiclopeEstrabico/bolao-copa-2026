...
- **`config`**:
  - `status` (Doc): `{ liberado_grupos, liberado_32avos, liberado_oitavas, liberado_quartas, liberado_semis, liberado_final, liberado_terceiro, cache_res_ts, cache_grupos_ts, cache_elim_ts }`
- **`tokens`**:
